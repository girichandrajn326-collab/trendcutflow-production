...
import { Eye, EyeOff, TrendingUp, Zap, Mail, Lock, User, AlertCircle, ArrowRight, Loader2 } from 'lucide-react';
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      if (tab === 'signin') {
        ...
        if (error) {
          // Disposable email error gets highlighted on the email field
        ...
        <div className="bg-slate-900/80 backdrop-blur-xl border border-white/[0.08] rounded-2xl shadow-2xl shadow-black/60 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} noValidate className="p-6 space-y-4">
            ...
            <div className="space-y-1.5">
              <label className="block text-xs font-medium text-slate-400 pl-1">Password</label>
